...
export function PropertyDocuments({ propertyId, refreshTrigger = 0 }: PropertyDocumentsProps) {
  ...
  className="btn-glass btn-animated-yellow flex items-center gap-2 font-semibold px-5 py-2 text-blue-900 group"
  type="button"
...
>
  ...
  <span className="relative flex items-center z-10">
    <motion.svg
      ...
      stroke="currentColor"
      initial={false}
      animate={isAddHovered ? { rotate: [0, -12, 12, -12, 12, 0], y: [0, -3, 3, -3, 3, 0] } : { rotate: 0, y: 0 }}
