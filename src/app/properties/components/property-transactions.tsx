...
export function PropertyTransactions({ property, propertyId, onAddTransaction, onDuplicateTransaction, onEditTransaction, onDeleteTransaction, refreshTrigger = 0 }: PropertyTransactionsProps) {
  ...
  const loadTransactions = async () => {
    try {
      ...
      console.log('Transactions récupérées (data):', data)
    } catch (error: any) {
  ...
  return (
    <div>
      <Card className="mt-6">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="flex gap-2">
            {property?.category && property.category.toLowerCase().includes('saisonni') && (
              <Button
                variant="outline"
        ...
        <CardContent>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-4">
            {/* Filtre année du mois comptable */}
                    ...
                    <TableHead className="p-3 text-sm font-medium text-gray-500 uppercase">
                      <div className="flex items-center space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <path d="M6 17l6-10 6 10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
      ...
      {/* Place la modale tout en bas du composant, hors du Card */}
      <SimpleCsvModal
